...
class ReturnQLearningTable3:
    def __init__(self, actions, state):
        ...
        if state == "RAW": 
            ...
            f = open('/Users/jingci/Desktop/RL/warehouseTest/WarehouseRobotPathPlanning-master/Return_table3.txt', 'rb')
            self.q_table = pickle.load(f)
            f.close()
        elif state == "PATH":
            f = open('/Users/jingci/Desktop/RL/warehouseTest/WarehouseRobotPathPlanning-master/Return_qtable3.txt', 'rb')
            self.q_table = pickle.load(f)
            f.close()
